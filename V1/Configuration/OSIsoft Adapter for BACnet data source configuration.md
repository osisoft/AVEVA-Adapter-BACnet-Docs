...
| **RequestDelay** | Optional | `string` | The delay between sending each request to an individual device. The value ranges from 0 to 10000 milliseconds that is represented as "00:00:10" or "00:60:00" The default is 0.|
...
| **ReconnectInterval** | Optional | `string` | The amount of time to wait before attempting to send requests to a device after it has disconnected. The value must be greater than 0. The default is 60 minutes that is represented as "01:00:00" or "00:60:00".|
