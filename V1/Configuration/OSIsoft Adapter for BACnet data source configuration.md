...
A successful discovery will result in populating [DataSelection Configuration](xref:OSIsoftAdapterforBACnetDataSourceConfiguration#bacnet-routed-device-data-source-example) and [DeviceConfiguration](xref:OSIsoftAdapterforBACnetDataSelectionConfiguration#BACnet-device-configuration).
