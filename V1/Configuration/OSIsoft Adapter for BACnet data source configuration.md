...
A successful discovery will result in populating [DataSelection](OSIsoft-Adapter-for-BACnet-data-selection-configuration.md/#Configure-BACnet-data-selection) and [DeviceConfiguration](#BACnet-device-configuration).
