...
2. Configure a BACnet data source for each BACnet device.<br>See [PI Adapter for BACnet data source configuration](xref:PIAdapterForBACnetDataSourceConfiguration#configure-bacnet-ua-data-source).

3. Configure a BACnet data selection for each BACnet data source.<br>See [PI Adapter for BACnet data selection configuration](xref:PIAdapterForBACnetDataSelectionConfiguration#configure-bacnet-ua-data-selection).
