...
<p sourcefile="V1/main/V1/Configuration/Logging configuration.md" sourcestartlinenumber="17" sourceendlinenumber="17">Complete the following procedure to change the logging configuration:</p>
<ol sourcefile="V1/main/V1/Configuration/Logging configuration.md" sourcestartlinenumber="19" sourceendlinenumber="35">
<li sourcefile="V1/main/V1/Configuration/Logging configuration.md" sourcestartlinenumber="19" sourceendlinenumber="21"><p sourcefile="V1/main/V1/Configuration/Logging configuration.md" sourcestartlinenumber="19" sourceendlinenumber="19">Using any text editor, create a file that contains the logging configuration in JSON form.</p>
...
<li sourcefile="V1/main/V1/Configuration/Logging configuration.md" sourcestartlinenumber="23" sourceendlinenumber="23"><p sourcefile="V1/main/V1/Configuration/Logging configuration.md" sourcestartlinenumber="23" sourceendlinenumber="23">Save the file, for example as <em>Component_Logging.json</em>.</p>
</li>
<li sourcefile="V1/main/V1/Configuration/Logging configuration.md" sourcestartlinenumber="25" sourceendlinenumber="35"><p sourcefile="V1/main/V1/Configuration/Logging configuration.md" sourcestartlinenumber="25" sourceendlinenumber="25">Use any of the <a class="xref" href="Configuration%20tools.html" data-raw-source="[Configuration tools](xref:ConfigurationTools)" sourcefile="V1/main/V1/Configuration/Logging configuration.md" sourcestartlinenumber="25" sourceendlinenumber="25">Configuration tools</a> capable of making HTTP requests to execute a PUT command with the contents of that file to the following endpoint: <code>http://localhost:5590/api/v1/configuration/&lt;ComponentId&gt;/Logging</code>.</p>
...
<p sourcefile="V1/main/V1/Configuration/Logging configuration.md" sourcestartlinenumber="31" sourceendlinenumber="31"> Example using curl (run this command from the same directory where the file is located):</p>
<pre sourcefile="V1/main/V1/Configuration/Logging configuration.md" sourcestartlinenumber="33" sourceendlinenumber="35"><code class="lang-bash">curl -d &quot;@Component_Logging.json&quot; -H &quot;Content-Type: application/json&quot; -X PUT &quot;http://localhost:5590/api/v1/configuration/&lt;ComponentId&gt;/Logging&quot;
</code></pre></li>
</ol>
<p sourcefile="V1/main/V1/Configuration/Logging configuration.md" sourcestartlinenumber="37" sourceendlinenumber="37">On successful execution, the log level change takes effect immediately during runtime. The other configurations (log file size and file count) get updated after the adapter is restarted.</p>
<p sourcefile="V1/main/V1/Configuration/Logging configuration.md" sourcestartlinenumber="39" sourceendlinenumber="39"><strong>Note:</strong>  Any parameter not specified in the updated configuration file will revert to the default schema value.</p>
<h2 id="logging-schema" sourcefile="V1/main/V1/Configuration/Logging configuration.md" sourcestartlinenumber="41" sourceendlinenumber="41">Logging schema</h2>
<p sourcefile="V1/main/V1/Configuration/Logging configuration.md" sourcestartlinenumber="43" sourceendlinenumber="43">The full schema definition for the logging configuration is in the component specific logging file: <em>AdapterName_Logging_schema.json</em>, <em>OmfEgress_Logging_schema.json</em>, or <em>System_Logging_schema.json</em> here:</p>
<p sourcefile="V1/main/V1/Configuration/Logging configuration.md" sourcestartlinenumber="45" sourceendlinenumber="45">Windows: <em>%ProgramFiles%\OSIsoft\Adapters\AdapterName\Schemas</em></p>
<p sourcefile="V1/main/V1/Configuration/Logging configuration.md" sourcestartlinenumber="47" sourceendlinenumber="47">Linux: <em>/opt/OSIsoft/Adapters/AdapterName/Schemas</em></p>
<h2 id="logging-parameters" sourcefile="V1/main/V1/Configuration/Logging configuration.md" sourcestartlinenumber="49" sourceendlinenumber="49">Logging parameters</h2>
<p sourcefile="V1/main/V1/Configuration/Logging configuration.md" sourcestartlinenumber="51" sourceendlinenumber="51">The following parameters are available for configuring logging:</p>
<table sourcefile="V1/main/V1/Configuration/Logging configuration.md" sourcestartlinenumber="53" sourceendlinenumber="57">
<thead>
<tr>
<th>Parameter</th>
<th>Required</th>
...
<h3 id="loglevel" sourcefile="V1/main/V1/Configuration/Logging configuration.md" sourcestartlinenumber="59" sourceendlinenumber="59">LogLevel</h3>
<table sourcefile="V1/main/V1/Configuration/Logging configuration.md" sourcestartlinenumber="61" sourceendlinenumber="69">
<thead>
<tr>
<th>Level</th>
<th>Description</th>
...
<tr>
<td>Information</td>
<td>Logs that track the general flow of the application. Any non-repetitive general information like the following can be useful for diagnosing potential application errors: <br> - Version information relating to the software at startup <br> - External services being used <br> - Data source connection string <br> - Number of measurements <br> - Egress URL <br> - Change of state “Starting”, “Stopping” <br> - Configuration</td>
</tr>
<tr>
<td>Warning</td>
...
<tr>
<td>Error</td>
<td>Logs that highlight when the current flow of execution is stopped due to a failure. These should indicate a failure in the current activity, not an application-wide failure. It can indicate an invalid configuration, unavailable external endpoint, internal flow error, and so on.</td>
</tr>
<tr>
<td>Critical</td>
...
<h2 id="example" sourcefile="V1/main/V1/Configuration/Logging configuration.md" sourcestartlinenumber="71" sourceendlinenumber="71">Example</h2>
<h3 id="default-logging-configuration" sourcefile="V1/main/V1/Configuration/Logging configuration.md" sourcestartlinenumber="73" sourceendlinenumber="73">Default logging configuration</h3>
<p sourcefile="V1/main/V1/Configuration/Logging configuration.md" sourcestartlinenumber="75" sourceendlinenumber="76">By default, logging captures Information, Warning, Error, and Critical messages in the message logs.
The following logging configuration is the default for a component on install:</p>
<pre sourcefile="V1/main/V1/Configuration/Logging configuration.md" sourcestartlinenumber="78" sourceendlinenumber="84"><code class="lang-json">{
  &quot;logLevel&quot;: &quot;Information&quot;,
  &quot;logFileSizeLimitBytes&quot;: 34636833,
  &quot;logFileCountLimit&quot;: 31
}
</code></pre><h2 id="rest-urls" sourcefile="V1/main/V1/Configuration/Logging configuration.md" sourcestartlinenumber="86" sourceendlinenumber="86">REST URLs</h2>
<table sourcefile="V1/main/V1/Configuration/Logging configuration.md" sourcestartlinenumber="88" sourceendlinenumber="93">
<thead>
<tr>
<th>Relative URL</th>
<th>HTTP verb</th>
...
<p sourcefile="V1/main/V1/Configuration/Logging configuration.md" sourcestartlinenumber="95" sourceendlinenumber="95"><strong>Note:</strong> Replace <em>ComponentId</em> with the Id of your adapter component, for example Modbus1 or OpcUa1.</p>
</article>
          </div>
